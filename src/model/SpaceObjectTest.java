...
public class SpaceObjectTest {
	...
	public void test_that_both_players_dont_collide() {
		Player player2 = new Player("Tester2", new Point(200, 200));
	...
	public void test_that_a_player_near_another_collides() {
		Player player2 = new Player("Tester2", new Point(110, 110));
	...
	public void test_that_overlapingObjects_works_with_no_overlapping_element() {
		...
		objects.add(new Asteroid(new Point(500, 500), 10, new Point()));
	...
	public void test_that_overlapingObjects_works_with_one_overlapping_element() {
		ArrayList<SpaceObject> objects = new ArrayList<SpaceObject>();
		Asteroid asteroid = new Asteroid(new Point(100, 100), 10, new Point());
	...
	public void test_that_overlapingObjects_returns_all_overlapping_element() {
		ArrayList<SpaceObject> objects = new ArrayList<SpaceObject>();
		Asteroid asteroid1 = new Asteroid(new Point(110, 110), 100, new Point());
		Asteroid asteroid2 = new Asteroid(new Point(110, 110), 100, new Point());
	...
	public void test_that_overlapingObjects_returns_only_overlapping_element() {
		ArrayList<SpaceObject> objects = new ArrayList<SpaceObject>();
		Asteroid asteroid0 = new Asteroid(new Point(110, 110), 100, new Point());
		Asteroid asteroid1 = new Asteroid(new Point(90, 90), 10, new Point());
		Asteroid asteroid2 = new Asteroid(new Point(510, 510), 10, new Point());
	...
	public void test_bounce_with_top_wall() {
		Asteroid asteroid = new Asteroid(new Point(10, 10), 5,
				new Point(10, -5));
		...
		assertEquals(new Point(10, 5), asteroid.getDirection());
	}

	@Test
	public void test_bounce_with_right_wall() {
		Asteroid asteroid = new Asteroid(new Point(10, 10), 5, new Point(10, 5));
		ArrayList<Boolean> a = new ArrayList<Boolean>();
		a.add(false);
		a.add(true);
		a.add(false);
	...
	public void test_if_non_static_bounce_let_both_change_directions() {
		player1.setDirection(new Point(1, 1));
		Player player2 = new Player("player2", new Point(0, 0));
		player2.setDirection(new Point(-1, -1));

		player1.bounce(player2);

		assertEquals(new Point(-1, -1), player1.getDirection());
		assertEquals(new Point(1, 1), player2.getDirection());
	}

	@Test
	public void test_if_non_static_bounce_let_both_exchange_speeds() {
		player1.setDirection(new Point(10, 1));
		Player player2 = new Player("player2", new Point(0, 0));
		player2.setDirection(new Point(-1, -5));

		player1.bounce(player2);

		assertEquals(new Point(-1, -5), player1.getDirection());
		assertEquals(new Point(10, 1), player2.getDirection());
	}
	...
	public void test_that_move_adds_the_direction_on_object() {
		Asteroid asteroid = new Asteroid(new Point(100, 100), 10, new Point(10,
				1));

		asteroid.move(RESOLUTION, new ArrayList<SpaceObject>());

		assertEquals(new Point(110, 101), asteroid.getPosition());
	}

	@Test
	public void test_that_move_doesnt_move_over_the_border() {
		Asteroid asteroid = new Asteroid(new Point(10, 10), 10, new Point(-10,
				-1));
	...
	public void test_that_move_doesnt_move_over_the_border_on_big_objects() {
		Asteroid asteroid = new Asteroid(new Point(110, 110), 100, new Point(
				-30, 0));
	...
	public void test_that_move_bounces_correctly_on_the_top_left_border() {
		...
		assertEquals(new Point(20, 11), asteroid.getPosition());
	}

	@Test
	public void test_that_move_bounces_correctly_on_the_right_border() {
		Asteroid asteroid = new Asteroid(new Point(625, 100), 10, new Point(10,
				0));

		asteroid.move(RESOLUTION, new ArrayList<SpaceObject>());

		assertEquals(new Point(625, 100), asteroid.getPosition());
	}

	@Test
	public void test_that_move_bounces_correctly_on_the_bottom_border() {
		Asteroid asteroid = new Asteroid(new Point(25, 305), 10, new Point(10,
				10));

		asteroid.move(RESOLUTION, new ArrayList<SpaceObject>());

		assertEquals(new Point(35, 305), asteroid.getPosition());
	}
	...
	public void test_that_move_bounces_correctly_on_the_border_on_big_objects() {
		...
		assertEquals(new Point(120, 110), asteroid.getPosition());
	}
	...
	public void test_that_move_changes_the_direction() {
		...
		assertEquals(new Point(10, 1), asteroid.getDirection());
	}
	...
	public void test_that_move_changes_the_direction_on_big_objects() {
		...
		assertEquals(new Point(30, 0), asteroid.getDirection());
	}
